...
class GenerateVueI18nCommand extends Command
{
    /**
    ...
    {
        $root = base_path() . config('inertia-uno.langPath');
        $config = config('inertia-uno');
        ...
        $this->comment('Writting generated file to ' . $jsFile);
    ...
    private function getFileName($fileNameOption)
    {
        ...
        return base_path() . config('inertia-uno.jsFile');
    }
